...
export const itemApi = {
  ...
  defaultFridge: () => request.get('/item/furniture/default-fridge'),
  ...
  unplaceFurniture: (id) => request.put(`/item/furniture/${id}/unplace`),
  ...
  take: (id, amount) => request.post(`/item/${id}/take`, { amount }),
  batchAssignFurniture: (data) => request.put('/item/batch/furniture', data),
