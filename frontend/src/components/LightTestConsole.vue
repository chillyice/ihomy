...
const initY = typeof window !== 'undefined' ? Math.max(42, window.innerHeight - 360) : 100
const { pos, onDragStart } = useDragResize({ x: 240, y: initY, minY: 42 })
...
const onDateChange = () => {
  ...
  light.loadSunInfoForDate?.(dateInput.value)
}
</script>
