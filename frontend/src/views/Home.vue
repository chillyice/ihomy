...
html.dark .weather-bg-grad { background: linear-gradient(165deg, rgba(var(--color-card-rgb),0.78) 0%, rgba(var(--color-card-rgb),0.34) 48%, rgba(var(--color-card-rgb),0.32) 100%); }
