...
public final class AiConst {
    ...
    /** 开源组件升级评估(台账 /ops/oss 升级前 AI 辅助决策) */
    public static final String FEATURE_OSS_UPGRADE_EVAL = "OSS_UPGRADE_EVAL";
    ...
    public static final Map<String, Set<String>> FEATURE_ALLOWED_TYPES = Map.of(
            ...
            FEATURE_OSS_UPGRADE_EVAL, Set.of(TYPE_LLM));
