...
- 前端构建:`cd frontend; npm run build` → 入口 chunk ≈318.8KB(2026-09-24 V9.90 实测 318.77KB/gzip 127.83KB,较 V9.89 的 318.71KB 增 0.06KB=独立页登录跳转守卫;旧基线 2026-09-08 V9.48 为 246.35KB/97.70KB;pdfjs 已隔离为独立异步 chunk ~483KB 仅 PDF 场景加载;simple-mind-map ~341KB 仅脑图编辑页加载;壁纸页独立 chunk 8.25KB/4.78KB 懒加载——V9.90 加双保险监听与诊断行)
