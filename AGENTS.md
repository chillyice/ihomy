...
|----|------|---------------------|--------|-----------|
| 账号 | 注册/登录/验证码/密码找回 | AuthController / AuthService | sys_user 等 | 邮箱=账号;JWT 双 token(2h/7d 滑动续期,HTTP 401 触发续期);开发验证码固定 qwer;演示账号 demo@ihomy.local 等/***REMOVED-DEMO-PASSWORD*** |
